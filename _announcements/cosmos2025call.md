---
title: COSMOS 2025 call for applications
week: 1
date: 2025-03-11
---

## COSMOS 2025 call for applications
...
For more details, check out the [overview of the summer school]({{ site.baseurl}}{% link about.md %}), our great lineup of [instructors]({{ site.baseurl}}{% link instructors.md %}), and the [FAQ]({{ site.baseurl}}{% link FAQ.md %}). 


### Apply by April 25th

Visit the [application portal]({{ site.baseurl}}{% link application.md %}) for more details.
<!-- Visit the [application portal]({{ site.baseurl}}{% link application.md %}) for more details. -->